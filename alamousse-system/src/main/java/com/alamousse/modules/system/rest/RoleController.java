...
public class RoleController {
    ...
    private CommonQueryCriteria criteriaShop =  new CommonQueryCriteria();
    ...
    public ResponseEntity getAll(@PageableDefault(value = 2000, sort = {"level"}, direction = Sort.Direction.ASC) Pageable pageable){
        this.setSearchShop(this.criteriaShop);

        return new ResponseEntity(roleService.queryAll(this.criteriaShop,pageable),HttpStatus.OK);
    }
    ...
    private void setSearchShop(CommonQueryCriteria criteria){
